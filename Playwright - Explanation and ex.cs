Playwright е мощна библиотека за автоматизирано тестване на уеб приложения, разработена от Microsoft. Позволява ти да симулираш потребителски действия в браузъри като Chrome, Firefox и Edge.
